let artists = [
  ...
  },
  {
    ...
    alias: ['Eyeliner', 'Super Doobie Bros'],
    description: `
  ...
  },
  {
    ...
    alias: ['Chuck Person', 'Dania Shapes', 'KGB Man', '0PN'],
    description: `
  ...
  {
    name: 'Blank Banshee',
    bandcamp: 'https://blankbanshee.bandcamp.com/',
    alias: [],
    description: `
    ...
    `,
    featImage: 'blankfeat.jpg',
    sideImage: 'blank.jpg',
    features: [
      { album: 'Blank Banshee 0', logo: 'blank0.jpg', link: 'https://blankbanshee.bandcamp.com/album/blank-banshee-0' },
      { album: 'Blank Banshee 1', logo: 'blank1.jpg', link: 'https://blankbanshee.bandcamp.com/album/blank-banshee-1' },
      { album: 'MEGA', logo: 'mega.jpg', link: 'https://blankbanshee.bandcamp.com/album/mega' }
    ]
  },
  {
    name: 'マクロスMACROSS 82-99',
    bandcamp: 'https://macross82-99.bandcamp.com/',
    alias: [],
    description: `
    ...
    `,
    featImage: 'macrossfeat.jpg',
    sideImage: 'macross.jpg',
    features: [
      { album: 'Sailorwave', logo: 'sailorwave.jpg', link: 'https://fortune500.bandcamp.com/album/sailorwave' },
      { album: 'A Million Miles Away', logo: 'miles.jpg', link: 'https://macross82-99.bandcamp.com/album/a-million-miles-away' },
      { album: 'Sailorwave II', logo: 'sailorwave2.jpg', link: 'https://macross82-99.bandcamp.com/album/sailorwave-ii' }
    ]
  }
]
