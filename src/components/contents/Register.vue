<template>
  <div>
    <section id="paragraph">
      <div id="validator">
        <p id="header">
          <img class="lacroix" src="../../../static/gifs/lacroix.gif"/>
        ...
        <p style="margin-top: 50px;"><button>Sign up</button></p>
      </div>
    </section>
  </div>
</template>
...
<style>
  #validator {
    width: 80%;
    padding: 50px;
    color: rgb(235, 240, 215);
    background: rgb(145, 201, 196);
    text-align: center;
    margin: 0 auto;
    margin-top: 50px;
    margin-bottom: 100px;
