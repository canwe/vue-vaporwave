      ...
      <v-card tile>
        ...
        <v-list>
          <v-list-tile>
            ...
            <v-list-tile-content fluid grid-list-md>
              <v-list-tile-title>
            ...
            <v-spacer></v-spacer>
            <v-list-tile-action>
              <v-btn @click="skipSong(0)" icon>
                <v-icon>skip_previous</v-icon>
              </v-btn>
            </v-list-tile-action>
            <v-list-tile-action class="hidden-xs-only">
              <v-btn @click="skipInterval(0)" icon>
            ...
            <v-list-tile-action class="hidden-xs-only">
              <v-btn @click="skipInterval(1)" icon>
                <v-icon>fast_forward</v-icon>
              </v-btn>
            </v-list-tile-action>
            <v-list-tile-action>
              <v-btn @click="skipSong(1)" icon>
